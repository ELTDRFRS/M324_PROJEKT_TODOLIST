# PowerShell script to run CI-built Docker images (Simple Version)
...
Write-Host "" 
Write-Host "Step 1: Pulling latest CI-built images..." -ForegroundColor Yellow
...
if ($LASTEXITCODE -ne 0) {
    ...
    Write-Host "   1. CI workflow has not run successfully yet" -ForegroundColor White
...
Write-Host ""
Write-Host "Step 3: Starting M324 Todo List with CI images..." -ForegroundColor Yellow
